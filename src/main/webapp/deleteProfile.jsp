...
<html>
 <head>
  ...
  <style>
   body {
            background:radial-gradient(circle at bottom left,orange,lavender);
            margin: 0;
		...
		<div class="container">
			<form class="form" action="delete" method="post">
				<h2>Delete Account</h2> 
				    <label>
				        <span>Email</span>
				        <input required placeholder="enter email" type="email" class="input" name="email">
				    </label> 
				    <br><br>
				    <label>
				    	<span>Password</span>
				        <input required placeholder="enter password" type="password" class="input" name="password">
